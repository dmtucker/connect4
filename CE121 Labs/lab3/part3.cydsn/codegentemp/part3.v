...
// UART_v2_30(Address1=0, Address2=0, BaudRate=38400, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, CtrlModeReplacementString=SyncCtl, Enable_RX=1, Enable_RXIntInterrupt=1, Enable_TX=1, Enable_TXIntInterrupt=1, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=true, FlowControl=1, HalfDuplexEn=false, HwTXEnSignal=false, InternalClock=true, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=16, ParityType=2, ParityTypeSw=false, RequiredClock=614400, RXAddressMode=0, RXBufferSize=64, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=64, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_COMPONENT_NAME=UART_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=UART, CY_INSTANCE_SHORT_NAME=UART, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=UART, )
module UART_v2_30_0 (
    rx_clk,
    rx_data,
    tx_clk,
...
module CharLCD_v1_80_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9b486c2c-7dc2-4229-b26f-c501033c197c/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam UART.ParityType = 2;
    defparam UART.RXEnable = 1;
    defparam UART.TXEnable = 1;

    CharLCD_v1_80_1 LCD ();

	wire [0:0] tmpOE__transmitter_net;
	wire [0:0] tmpFB_0__transmitter_net;
	wire [0:0] tmpIO_0__transmitter_net;
	wire [0:0] tmpINTERRUPT_0__transmitter_net;
	electrical [0:0] tmpSIOVREF__transmitter_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		transmitter
		 (.oe(tmpOE__transmitter_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__transmitter_net[0:0]}),
		  .io({tmpIO_0__transmitter_net[0:0]}),
		  .siovref(tmpSIOVREF__transmitter_net),
		  .interrupt({tmpINTERRUPT_0__transmitter_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__transmitter_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b8af779d-8f4b-4d81-a5c0-1175210a6619"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
