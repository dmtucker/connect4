...
module CharLCD_v1_80_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b24909a4-7ac4-43c7-a4c8-e8f2cb769b14/ed092b9b-d398-4703-be89-cebf998501f6"),
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\and_v1_0\and_v1_0.v"
`endif
...
module ADC_DelSig_v2_30_4 (
	...
	cy_clock_v1_0
		#(.id("01b19a18-92c9-434c-b946-25cdf192ac3b/edd15f43-b66b-457b-be3a-5342345270c8"),
	...
	cy_clock_v1_0
		#(.id("01b19a18-92c9-434c-b946-25cdf192ac3b/b7604721-db56-4477-98c2-8fae77869066"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("390625000"),
		  .is_direct(0),
...
module top ;
    ...
    assign Net_36 = Net_2 | Net_1;


    assign Net_39 = Net_5 | Net_2;

    CyControlReg_v1_70 Controller (
        .control_1(Net_418),
        .control_2(Net_5),
        .control_3(Net_492),
        .control_0(Net_1),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Controller.Bit0Mode = 0;
    defparam Controller.Bit1Mode = 0;
    defparam Controller.Bit2Mode = 0;
    defparam Controller.Bit3Mode = 0;
    defparam Controller.Bit4Mode = 0;
    defparam Controller.Bit5Mode = 0;
    defparam Controller.Bit6Mode = 0;
    defparam Controller.Bit7Mode = 0;
    defparam Controller.BitValue = 0;
    defparam Controller.BusDisplay = 0;
    defparam Controller.ExtrReset = 0;
    defparam Controller.NumOutputs = 3;
    ...
    assign Net_40 = Fuel & Net_36;


    assign Net_43 = Net_39 & Fuel;
	...
	cy_clock_v1_0
		#(.id("4de24e01-6f7e-4366-8de3-daca7b01a634"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("072b9168-ffe8-49b2-ae9f-47eeeeed3974"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Brakelight_net;
	wire [0:0] tmpFB_0__Brakelight_net;
	wire [0:0] tmpIO_0__Brakelight_net;
	wire [0:0] tmpINTERRUPT_0__Brakelight_net;
	electrical [0:0] tmpSIOVREF__Brakelight_net;

	cy_psoc3_pins_v1_10
		#(.id("1db6db1a-919d-4a46-8242-e89de7b5f024"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Brakelight
		 (.oe(tmpOE__Brakelight_net),
		  .y({Net_2}),
		  .fb({tmpFB_0__Brakelight_net[0:0]}),
		  .io({tmpIO_0__Brakelight_net[0:0]}),
		  .siovref(tmpSIOVREF__Brakelight_net),
		  .interrupt({tmpINTERRUPT_0__Brakelight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Brakelight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Taillight_net;
	wire [0:0] tmpFB_0__Taillight_net;
	wire [0:0] tmpIO_0__Taillight_net;
	wire [0:0] tmpINTERRUPT_0__Taillight_net;
	electrical [0:0] tmpSIOVREF__Taillight_net;

	cy_psoc3_pins_v1_10
		#(.id("80f72b1f-bac7-441f-8400-7f15aed8592b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Taillight
		 (.oe(tmpOE__Taillight_net),
		  .y({Net_1}),
		  .fb({tmpFB_0__Taillight_net[0:0]}),
		  .io({tmpIO_0__Taillight_net[0:0]}),
		  .siovref(tmpSIOVREF__Taillight_net),
		  .interrupt({tmpINTERRUPT_0__Taillight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Taillight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_519 = ~Net_570;
