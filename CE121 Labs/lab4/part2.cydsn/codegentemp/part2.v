...
module ADC_DelSig_v2_30_2 (
	...
	cy_clock_v1_0
		#(.id("264cc729-5de0-4fb4-a7b4-d6d2a2d84947/edd15f43-b66b-457b-be3a-5342345270c8"),
	...
	cy_clock_v1_0
		#(.id("264cc729-5de0-4fb4-a7b4-d6d2a2d84947/b7604721-db56-4477-98c2-8fae77869066"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("390625000"),
		  .is_direct(0),
...
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v2_30"
`include "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_PWM_v2_30\B_PWM_v2_30.v"
`endif
...
// PWM_v2_30(CaptureMode=0, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=39, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_COMPONENT_NAME=PWM_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=PWM, CY_INSTANCE_SHORT_NAME=PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=PWM, )
module PWM_v2_30_3 (
    pwm2,
    tc,
    clock,
...
module CharLCD_v1_80_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ea389e31-781f-4cf6-aed1-ed0172069b75/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Component: B_Counter_v2_30
`ifdef CY_BLK_DIR
`undef CY_BLK_DIR
`endif

`ifdef WARP
`define CY_BLK_DIR "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Counter_v2_30"
`include "$CYPRESS_DIR\..\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Counter_v2_30\B_Counter_v2_30.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Counter_v2_30"
`include "C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Counter_v2_30\B_Counter_v2_30.v"
`endif

// Counter_v2_30(CaptureMode=1, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=65535, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=true, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_COMPONENT_NAME=Counter_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Counter, CY_INSTANCE_SHORT_NAME=Counter, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Counter, )
module Counter_v2_30_5 (
    clock,
    comp,
    tc,
    reset,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("7ab8c5cf-a8f3-4c25-8907-6f623944df6f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Accelerator_net;
	wire [0:0] tmpFB_0__Accelerator_net;
	wire [0:0] tmpIO_0__Accelerator_net;
	wire [0:0] tmpINTERRUPT_0__Accelerator_net;
	electrical [0:0] tmpSIOVREF__Accelerator_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .width(1))
		Accelerator
		 (.oe(tmpOE__Accelerator_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Accelerator_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__Accelerator_net[0:0]}),
		  .siovref(tmpSIOVREF__Accelerator_net),
		  .interrupt({tmpINTERRUPT_0__Accelerator_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Accelerator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tachometer_net;
	wire [0:0] tmpIO_0__Tachometer_net;
	wire [0:0] tmpINTERRUPT_0__Tachometer_net;
	electrical [0:0] tmpSIOVREF__Tachometer_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .width(1))
		Tachometer
		 (.oe(tmpOE__Tachometer_net),
		  .y({1'b0}),
		  .fb({Net_101}),
		  .io({tmpIO_0__Tachometer_net[0:0]}),
		  .siovref(tmpSIOVREF__Tachometer_net),
		  .interrupt({tmpINTERRUPT_0__Tachometer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tachometer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("339bde8b-e009-43b4-9995-02c374fd0ffd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Indicator_net;
	wire [0:0] tmpFB_0__Indicator_net;
	wire [0:0] tmpIO_0__Indicator_net;
	wire [0:0] tmpINTERRUPT_0__Indicator_net;
	electrical [0:0] tmpSIOVREF__Indicator_net;

	cy_psoc3_pins_v1_10
		#(.id("4fd4dcef-fa3f-4a13-ab9c-daa7e980fd56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		Indicator
		 (.oe(tmpOE__Indicator_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Indicator_net[0:0]}),
		  .io({tmpIO_0__Indicator_net[0:0]}),
		  .siovref(tmpSIOVREF__Indicator_net),
		  .interrupt({tmpINTERRUPT_0__Indicator_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Indicator_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_95 = ~Net_98;


    assign Net_103 = ~Net_101;
