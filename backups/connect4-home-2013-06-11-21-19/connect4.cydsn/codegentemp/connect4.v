...
module top ;
	...
	wire [0:0] tmpOE__Remote_net;
	wire [0:0] tmpFB_0__Remote_net;
	wire [0:0] tmpIO_0__Remote_net;
	wire [0:0] tmpINTERRUPT_0__Remote_net;
	electrical [0:0] tmpSIOVREF__Remote_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("72a1ef96-908b-4c9d-ab07-305b3196c5e2"),
		  ...
		  .width(1))
		Remote
		 (.oe(tmpOE__Remote_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Remote_net[0:0]}),
		  .io({tmpIO_0__Remote_net[0:0]}),
		  .siovref(tmpSIOVREF__Remote_net),
		  .interrupt({tmpINTERRUPT_0__Remote_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Remote_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Selector_net;
	wire [0:0] tmpIO_0__Selector_net;
	wire [0:0] tmpINTERRUPT_0__Selector_net;
	electrical [0:0] tmpSIOVREF__Selector_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("913793fd-6444-4e37-8a1d-5270b61acf8e"),
		  ...
		  .width(1))
		Selector
		 (.oe(tmpOE__Selector_net),
		  .y({1'b0}),
		  .fb({Net_314}),
		  .io({tmpIO_0__Selector_net[0:0]}),
		  .siovref(tmpSIOVREF__Selector_net),
		  .interrupt({tmpINTERRUPT_0__Selector_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Selector_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
